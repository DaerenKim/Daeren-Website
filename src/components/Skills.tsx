...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      icon: Brain,
      skills: ["pandas", "numpy", "matplotlib", "seaborn", "plotly", "scikit-learn", "HuggingFace", "Ollama", "FastAPI", "Flask"],
    ...
    },
    {
      ...
      icon: BarChart3,
      skills: ["Machine Learning", "Statistical Analysis", "Data Visualization", "Regression Analysis", "NLP", "RAG Systems", "Supervised Learning", "Unsupervised Learning"],
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center">
            <Card className="card-gradient tech-glow max-w-sm">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <h4 className="font-semibold text-foreground">{certifications[0].name}</h4>
                    <p className="text-muted-foreground">by {certifications[0].issuer}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        {/* Relevant Coursework */}
        <div className="mt-16">
          <h3 className="text-2xl font-bold mb-8 text-center text-foreground">Relevant Coursework</h3>
